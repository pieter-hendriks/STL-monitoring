...
class Interval:
	""" Implementation of a mathematical Interval; supports both closed and half-open. """
	...
	def computeIntersection(cls, lhs: 'Interval', rhs: 'Interval') -> 'Interval':
		...
		return Interval(max(lhs.getLower(), rhs.getLower()), min(lhs.getUpper(), rhs.getUpper()))
