...
def __addLargerThanPreviousAndDescendingResult(signal: Signal, timeIndex: int, previousResult: float, output: Signal) -> None: 
...
def __addCrossesPreviousAndDescendingResult(signal: Signal, timeIndex: int, previousResult: float, output: Signal) -> None: 
